...
salary_vs <-function(data,col_name, box_color = "skyblue", data_source = "2024 Salary Dataset"){
  ...
  label_text <-readable_names[[col_name]]
  data|>
    ...
    ggplot( aes_string(x=col_name, y ="salary" ))+
      ...
      labs(title = paste("Salary by", label_text),
           subtitle = paste("Exploratory Analysis of", label_text, "vs Salary"),
           x = label_text,
           y = "Salary (USD)",
           caption = data_source) +
...
ggsave("plot4.png", width = 10, height = 6, dpi = 300)
